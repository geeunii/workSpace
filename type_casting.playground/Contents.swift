...
result = geuni is Person // true
result = geuni is Student // false
result = geuni is UniversityStudent // false
...
doSomethingWithSwitch(someone: geuni)
// 숨을 쉽니다.
